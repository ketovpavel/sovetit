...
class Block_Container extends Container {
	...
	/**
	 * Выводит пример будущего блока (изображение) в превьюшке
	 *
	 * @see sv_cover_example
	 *
	 * @param null $cover
	 *
	 * @return $this
	 ...
	 * Date: 12.05.2021
	 */
	public function sv_cover_example( $cover = null ) {
		$this->settings[ 'cover_example' ] = $cover;
		return $this;
	}
